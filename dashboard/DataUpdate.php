    ...
    <div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
        ...
        if (isset($_POST['ubah'])) {
            ...
            $values = array(
                ...
                // ID pengajuan (sesuaikan dengan kolom ID yang sesuai di tabel)
                $id_pengajuan
            );

            // Bind parameter
            $types = str_repeat('s', count($values));  // 's' untuk string, bisa disesuaikan
